...
<body>
    <form action="process.php" method="POST">
        ...
        <div class="container" id="product_form" style="margin-top: 10px;">
            <div class="form-group">
                <label>SKU</label>
                <input style="margin-left: 13px" id="sku" type="text" name="sku">
            </div>
            ...
            <div class="form-group " style="margin-top: 10px">
                <label>Price</label>
                <input style="margin-left: 8px" id="price" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxLength="10" type="number" name="price">
            </div>
            
            <label style="margin-top: 10px;" >Type Switcher</label>
                <select name="select" id="productType" onchange="addinputs(this.value)" id="productType">
