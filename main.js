...
function addinputs(x){
    ...
    if(x==='select'){
        ...
        <div class="form-group" style="margin-top: 10px">
        <label>Size(MB)</label>
        <input type="number" id="size" oninput="${inputLen}" maxlength="10" name="mb">
        </div>`;
    }else if(x==='book'){
        productInputs.innerHTML=`
        <div class="form-group" style="margin-top: 10px">
        <label>Weight(KG)</label>
        <input type="number" id="weight" oninput="${inputLen}"  maxlength="10" name="kg">
        </div>`;
        ...
        <input type="number" id="height" oninput="${inputLen}" maxlength="5" name="height">
        <br>
        <label style="margin-top: 10px">Width(CM)</label>
        <input style="margin-left: 6px" id="width" oninput="${inputLen}" maxlength="5" type="number" name="width">
        <br>
        <label style="margin-top: 10px">Length(CM)</label>
        <input type="number" id="lenght" oninput="${inputLen}" maxlength="5" name="length">
        </div>`;
    }
